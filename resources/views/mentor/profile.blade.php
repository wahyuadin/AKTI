            ...
            <form action="{{ route('profile.mentor_vokasi.leader_post') }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <select class="form-select" name="section_id" aria-label="Default select example">
                            ...
                            @foreach ($section as $section)
                                <option value="{{ $section->id }}">{{ $section->user->nama }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12 mt-3">
                        <label for="inputEmail" class="form-label">No Telp</label>
                        <input type="number" class="form-control" name="no_telp" placeholder="Masukan Kolom Nomor Telpon"
            ...
            <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    @if ($data->isEmpty())
                                        <div class="col-md-8">
                                            <p style="color: red"> {{ isset($data->first()->leader) ? 'Bpk/Ibu '.
                                                $data->first()->leader : 'Input Leader & Section Untuk Mengakses' }} <button
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <p style="text-transform: uppercase;"> {{ $mentor->user->nama }}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-8">
                                            <p id="nama"> {{ $mentor->user->nomor_induk }}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <p id="nama">{{ $mentor->user->alamat }}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <p id="nama"> {{ $mentor->section->user->nama }} <button type="button" data-bs-toggle="modal" data-bs-target="#section" class="btn btn-info btn-xs rounded">Update</button></p>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                ...
                <div class="tab-pane" id="settings">
                    ...
                    <form method="POST" action="{{ route('upload.mentor_vokasi', ['id' => $data->value('id')]) }}"
                        ...
                        @method('PUT')
                        @foreach ($data as $mentor)
                        <input type="text" name="id_mentor" value="{{ $mentor->id }}" readonly hidden>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="inputName" class="form-label">Nama :</label>
                                <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama"
                                    value="{{ $mentor->user->nama }}" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="no_telp" placeholder="Contact"
                                    value="{{ $mentor->no_telp }}">
                            </div>
                            <div class="col-md-6">
                                <label for="inputEmail" class="form-label">Email :</label>
                                <input type="email" class="form-control" name="email" placeholder="Email"
                                    value="{{ $mentor->user->email }}" disabled>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="nomor_induk" placeholder="Nomor Induk"
                                    value="{{ $mentor->user->nomor_induk }}" readonly>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="alamat"
                                    rows="4">{{ $mentor->user->alamat }}</textarea>
                            </div>
                            @endforeach
                            <div class="col-12">
