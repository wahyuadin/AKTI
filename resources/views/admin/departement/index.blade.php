                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    name="departement"
                                                                    value="{{$item->departement}}" required>
                                                            </div>
                                                        </div>
                                                </div>
                                    ...
                                    <form action="{{url('admin/departement/'.$item->id)}}" method="post" id="hapus-departement">
                                        @csrf
                                        @method('delete')
                                        <button class="btn btn-danger btn-sm" style="margin-left: 2px" type="button"
                                            onclick="clickDept()"><i class='bx bx-trash'></i></button>
                                    </form>
                                    <a href="{{url('admin/departement/'.$item->id)}}" class="btn btn-primary btn-sm" target="_blank" style="margin-left: 2px" rel="noopener noreferrer">
    ...
    function clickDept() {
      Swal.fire({
          ...
          if (result.isConfirmed) {
              document.getElementById('hapus-departement').submit();
          }
      });
