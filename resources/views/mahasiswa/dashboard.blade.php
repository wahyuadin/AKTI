                ...
                <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                  <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                    <div class="card-title">
                      <h5 class="text-nowrap mb-2">Rekap Absen Bulan - <b>{{ $donat['bulan'] }}</b></h5>
                    </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    new Chart(chart, {
        ...
        datasets: [
                {
                    label: 'Accept',
                    data: @json($chart['accept']),
                    borderWidth: 2
                },
                {
                    label: 'Reject',
                    data: @json($chart['reject']),
                    borderWidth: 2
                },
                {
                    label: 'Pending',
                    data: @json($chart['pending']),
                    borderWidth: 2
                }
            ]
        },
